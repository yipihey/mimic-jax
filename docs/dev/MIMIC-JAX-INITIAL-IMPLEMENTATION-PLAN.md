...
**Status:** Active fork-local implementation plan; all fiducial process modules, tree-state inheritance maps, and the complete FoF-group schedule implemented and process-gated 2026-08-18.
